    ...
    public void setItem(Entity item) {
        ...
        for (CardRole cR : cardRole) {
            ...
            || (cR.getCode().equals("office_manager") && cR.getUser().getLogin().equals(user.getLogin())
                    && (WfUtils.isCardInState(call, "Zvonok_otklonen_ispolnitelem") || WfUtils.isCardInState(call, "Zvonok_prinyat")))) {
                callSetEditable(true);
            }
        }

        if (WfUtils.isCardInState(call, "Obrabotan")) callSetEditable(false);
